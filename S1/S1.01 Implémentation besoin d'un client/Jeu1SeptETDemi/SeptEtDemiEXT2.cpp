...
int main (){
    ...
    do
    {
        ...
        do
        {
            for (int i = 1; i <= 5; i++)
            {
                cout << "TOUR " << i << "/5 - SCORE PARTIE (" << scoreTotal << ")" <<endl;
                do
                {
        ...
        do
        {
            cout << "Voulez-vous jouer une nouvelle fois ? (o/n) : ";
            cin >> nouvJeu;
        } while(!((nouvJeu == 'o')||(nouvJeu == 'O')||(nouvJeu == 'n')||(nouvJeu == 'N')));
        cout << endl;

    } while (!((nouvJeu == 'n')||(nouvJeu == 'N')));
