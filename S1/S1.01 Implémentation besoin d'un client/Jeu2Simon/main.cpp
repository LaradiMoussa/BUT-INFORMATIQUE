/*
    ...
    Auteur : C.Naudi
    Remarques : Code conforme à l'algorithme
*/
#include <iostream>
...
int main(void)
{
    ...
    UneCouleur verifErreur; //Variable qui servira à comparer la valeur saisie par l'utilisateur à celle du Simon
    /////////////////////////
    //V A R I A B L E S
    int nbTour; //Initialisation du nombre de tour à 0
    ...
    int iteration; //La variable servant à afficher les caractères précedent durant la saisie du joueur
    ...
    bool jokerUtilise; //Le booléen servant à savoir si le joker a été utilisé, initialisé à faux
