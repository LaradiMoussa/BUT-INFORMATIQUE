/**
 * @author Colas NAUDI Matteo SUHUBIETTE Gatien TRAN
 * @name jeu.cpp
 ...
 * @note Colas, Matteo & Gatien certifions que le code ci-dessous a été notre propre création.
 *       Et qu'aucune ressource extérieure n'a été utilisée. Nous n'acceptons pas le plagiat.
*/
...
void verifCoord(unsigned int& nbTour, string& saisieJoueur)
{
    ...
    } while ((!((saisieJoueur[0]=='A')||(saisieJoueur[0]=='B')||(saisieJoueur[0]=='C')||(saisieJoueur[0]=='D')||(saisieJoueur[0]=='E')||(saisieJoueur[0]=='F')||(saisieJoueur[0]=='G')||(saisieJoueur[0]=='H')||(saisieJoueur[0]=='I')||(saisieJoueur[0]=='@')))||(!((saisieJoueur[1]=='1')||(saisieJoueur[1]=='2')||(saisieJoueur[1]=='3')||(saisieJoueur[1]=='4')||(saisieJoueur[1]=='5')||(saisieJoueur[1]=='6')||(saisieJoueur[1]=='7')||(saisieJoueur[1]=='8')||(saisieJoueur[1]=='9')||(saisieJoueur[1]=='@'))));
}
