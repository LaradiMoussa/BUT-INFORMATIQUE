 ...
 * @desc Programme principal de la bataille navale
 */
//cd "/Users/colasnaudi/Desktop/GitHub/BUT-INFO/S1/S1.02 Comparaison d'approches algorithmiques/BatailleNavale/BatailleNavale_/" && g++ BatailleNavale.cpp bateau.cpp jeu.cpp game-tools.cpp -o BatailleNavale && "/Users/colasnaudi/Desktop/GitHub/BUT-INFO/S1/S1.02 Comparaison d'approches algorithmiques/BatailleNavale/BatailleNavale_/"BatailleNavale
#include <iostream>
using namespace std;
#include "bateau.h"     // Module bateau contenant les procédures relatives au bateau.
#include "jeu.h"        // Module jeu contenant les procédures & fonctions relatives au jeu.
#include "game-tools.h"    // Module game-tools pour afficher les caractères en couleurs et utiliser une fonction random.
